...
def send_mail_function3():
    ...
    subject = 'EMERGENCY'
    body = """"
    GUN SHOTS MIGHT HAVE BEEN SEEN AT 36.13379407735641 LATITUDE AND 72.69994205020329 LONGITUDE
    """
    em = EmailMessage()
...
lab2 = Label(wi1, text="HELMET DETECTOR",bg='Black', fg='White',font=('Arial',30)).place(x=910,y=50)
bt2 = Button(wi1, text="click",font=('Arial',20), command=funct2)
bt2.place(x=1020,y=110)

#l3 = Label(wi1, text='').pack()
lab3 = Label(wi1, text="INSURANCE CHECKER",bg='Black', fg='White',font=('Arial',30)).place(x=910,y=200)
bt3 = Button(wi1, text="click",font=('Arial',20), command=funct3)
bt3.place(x=1020,y=260)

lab4 = Label(wi1, text="SPEED DETECTOR",bg='Black', fg='White',font=('Arial',30)).place(x=910,y=350)
bt4 = Button(wi1, text="click",font=('Arial',20), command=funct4)
bt4.place(x=1020,y=410)
wi1.mainloop()
